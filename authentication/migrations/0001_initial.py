    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('general', 'General'), ('agency_referred', 'Agency Referred'), ('employer', 'Employer'), ('training_provider', 'Training Provider'), ('agency', 'Agency'), ('admin', 'Admin')], max_length=20)),
