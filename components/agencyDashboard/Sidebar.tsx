...
const Sidebar = ({
  ...
  const routes = [
    { name: "Overview", icon: BarChart3, path: "/agency-dashboard" },
    {
      name: "User Roster",
      icon: Users,
      path: "/agency-dashboard/user-roster",
    },
    { name: "Reports & Export", icon: Shield, path: "/agency-dashboard/reports" },
    { name: "Manage Case", icon: Shield, path: "/agency-dashboard/case" },
    { name: "Audit Logs", icon: Sparkles, path: "/agency-dashboard/audit" },
  ];

  // Helper function to check if route is active
  const isRouteActive = (routePath: string) => {
    // Exact match for agency-dashboard overview
    if (routePath === "/agency-dashboard") {
