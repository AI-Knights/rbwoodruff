...
export default function AdminProfile() {
  ...
  const onSubmit = async (data: ProfileFormData) => {
    try {
      ...
      toast.success(`${response.full_name} updated`);
    } catch (e) {
      const error = e as any; // Using any to safely access error properties
      toast.error(error?.data?.details || error?.data?.error || "Failed to update profile");
    }
  };
  // console.log(image)
