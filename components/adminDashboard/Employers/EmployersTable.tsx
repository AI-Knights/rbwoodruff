                ...
                {uiEmployers.map((employer) => (
                  <tr key={employer.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-6">
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-md text-sm font-medium ${employer.uiStatus === "Verified"
            ...
            <Card key={employer.id}>
              <CardHeader className="pb-3">
                <div className="flex justify-between items-start">
                  ...
                  <span
                    className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ${employer.uiStatus === "Verified"
                      ? "bg-green-100 text-green-800"
                      : employer.uiStatus === "Pending"
                        ? "bg-yellow-100 text-yellow-800"
                        : "bg-red-100 text-red-800"
            ...
            {selectedEmployer && (
              <div className="grid grid-cols-2 gap-6 pt-2">
                ...
                <div>
                  ...
                  <span
                    className={`inline-flex items-center px-3 py-1 rounded-md text-sm font-medium ${selectedEmployer.status === "verified"
                      ? "bg-green-100 text-green-800"
