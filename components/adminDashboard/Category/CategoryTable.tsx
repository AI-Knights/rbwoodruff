          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="px-6 py-5">Slug</TableHead>
                <TableHead className="px-6 py-5">Description</TableHead>
                <TableHead className="px-6 py-5">Status</TableHead>
                <TableHead className="px-6 py-5">Jobs</TableHead>
                <TableHead className="px-6 py-5">Trainings</TableHead>
            ...
            <TableBody>
              {paginatedCategories.map((category) => (
                <TableRow key={category.id}>
                  <TableCell className="px-6 py-6">{category.name}</TableCell>
                  <TableCell className="px-6 py-6">{category.slug}</TableCell>
                  <TableCell className="px-6 py-6 max-w-xs truncate">
                  ...
                  <TableCell className="px-6 py-6">{category.job_count}</TableCell>
                  <TableCell className="px-6 py-6">{category.training_count}</TableCell>
