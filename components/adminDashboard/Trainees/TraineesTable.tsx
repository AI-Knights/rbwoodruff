      ...
      <div className="space-y-4">
        ...
        <div className="hidden md:block bg-white rounded-lg shadow overflow-hidden">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="px-6 py-5">Full Name</TableHead>
                <TableHead className="px-6 py-5">Email</TableHead>
                <TableHead className="px-6 py-5">Enrolled Program</TableHead>
                <TableHead className="px-6 py-5">Provider</TableHead>
                <TableHead className="px-6 py-5">Certificate</TableHead>
            ...
            <TableBody>
              {paginatedTrainees.map((trainee) => (
                <TableRow key={trainee.id}>
                  <TableCell className="px-6 py-6">{trainee.user_name}</TableCell>
                  <TableCell className="px-6 py-6">{trainee.user_email}</TableCell>
                  <TableCell className="px-6 py-6">{trainee.program_name}</TableCell>
                  <TableCell className="px-6 py-6">{trainee.provider_name}</TableCell>
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between bg-white rounded-lg shadow p-4 mt-4">
            <p className="text-sm text-gray-500">
              Showing {((currentPage - 1) * itemsPerPage) + 1} to {Math.min(currentPage * itemsPerPage, filteredTrainees.length)} of {filteredTrainees.length}
            </p>
